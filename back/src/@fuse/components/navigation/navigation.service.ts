...
export class FuseNavigationService
{
    ...
    // Private
    protected _onNavigationChanged: BehaviorSubject<any>;
    protected _onNavigationRegistered: BehaviorSubject<any>;
    protected _onNavigationUnregistered: BehaviorSubject<any>;
    protected _onNavigationItemAdded: BehaviorSubject<any>;
    protected _onNavigationItemUpdated: BehaviorSubject<any>;
    protected _onNavigationItemRemoved: BehaviorSubject<any>;

    protected _currentNavigationKey: string;
    protected _registry: { [key: string]: any } = {};
