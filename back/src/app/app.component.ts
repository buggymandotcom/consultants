...
export class AppComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        this.navigation = navigation.map(n => new NavigationItem(n));
        ...
        //
        // this.authService.authUser().map(d=>{
        //    this.authService.subscriptions.next(new User(d).subscriptions);
        //    this.authService.subscriptions$.subscribe(s=>console.log(s));
        // });
