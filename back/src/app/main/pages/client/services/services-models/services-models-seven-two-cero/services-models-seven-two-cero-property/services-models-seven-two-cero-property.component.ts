...
@Component({
  selector: 'app-services-models-seven-two-one-property',
  templateUrl: './services-models-seven-two-cero-property.component.html',
  styleUrls: ['./services-models-seven-two-cero-property.component.scss']
})
export class ServicesModelsSevenTwoCeroPropertyComponent implements OnInit {
