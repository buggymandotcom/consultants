...
@Component({
  selector: 'app-services-models-seven-two-one',
  templateUrl: './services-models-seven-two-cero.component.html',
  styleUrls: ['./services-models-seven-two-cero.component.scss']
})

export class ServicesModelsSevenTwoCeroComponent implements OnInit {
    ...
    *  */
    ...
    ngOnInit() {
        ...
        this.client_id = this.client_id = new User(JSON.parse(localStorage.getItem('currentUser'))).id;
    ...
    * */
    ...
    public goToModels(): void{
        this.router.navigate(['/client/services/models/'+this.model_id]);
    }
