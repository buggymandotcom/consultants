...
@Component({
  selector: 'app-adm-client-model-two-one-cero',
  templateUrl: './adm-client-model-two-one-cero.component.html',
  styleUrls: ['./adm-client-model-two-one-cero.component.scss']
})

export class AdmClientModelTwoOneCeroComponent implements OnInit, AfterViewInit {
